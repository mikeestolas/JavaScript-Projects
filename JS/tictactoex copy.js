...
function placeXOro(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
         ...
         checkWinConditions() ;
             if (activePlayer === 'X') {
                 //if active player is for changing the active player.
                 activePlayer = 'O';
                 //if active player is anthjing other than 'X'

             } else {
                 //change the active player tp 'X'
                 activePlayer = 'X';
             }
...
function checkWinConditions() {
    ...
    //I is used to check for each win condition.
    function arrayIncludes(squareA, squareB, squareC) {
        //The next 3 variables will be used to check for 3 in a row.
        const a = selectedSquares.includes(squareA);
        const b = selectedSquares.includes(squareB);
        const c = selectedSquares.includes(squareC);
        //If the 3 variables we pass are all included in our array trie is
...
function drawWinLine(coodX1, coordY1, coordX2, coordY2) {
    //This line acesses out html canvas element.
...
//This function takes a string parameter of the path you set earlier for 
//placemnent sound ('./media/place.mp3')
function audio (audioURL) {
//We create a new audio object and we pass the path as a parameter.
let audio = new Audio(audioURL) ;
//Play method plays our audio sound.
...
//This function utilizes htl canvas to draw win lines.
...
let x1 = coordX1,
	...
	//This line indicates where the end of a lines x axis is. 
	y2 = coordY2,
	//This variable stores temporary x axis data weupdate in our animation loop.
	x = x1,
	...
	function animateLineDrawing () {
		...
		//This methd clears content from the last loop iteration.
	...
	//This fuction clears our canvas after our win line is drawn.
	function clear() {
...
function resetGame() {
    //his for loop iterates through each HTML square element.
    for (let i = 0; < 9; i++) {
